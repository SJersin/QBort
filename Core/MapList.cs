...
namespace QBort
{
    public class MapList
    {
        ...
        */
        ...
        private static readonly string[] Paladins = { "Frog Isle", "Jaguar Falls", "Serpent Beach", "Frozen Guard", "Ice Mines", "Fish Market", "Timber Mill", "Stone Keep", "Brightmarsh", "Splitstone Quarry", "Ascension Peak", "Warder's Gate", "Shattered Desert", "Bazaar" };
        private static readonly string[] PalGameModes = { "Siege", "Onslaught", "King of the hill", "Team Deathmatch", "Ranked" };
